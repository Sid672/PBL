...
# In this class which initialized the width and height of the window,
# variables that are needed for calculation and then we initialized the pygame and loaded the images.
